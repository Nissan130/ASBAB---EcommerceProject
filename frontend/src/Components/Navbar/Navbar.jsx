...
const Navbar = () => {
  ...
  const {cartItems, favouriteCount} = useContext(CartContext); // Fetch cartItems from context
        ...
        <ul className="category-navbar">
          <li className="category-hover-list">
            ...
            <ul className="category-hover-list-items">
              <li className="newCollection-side-list">
                New Collections <span><RiArrowRightSLine /></span>
                <ul>
                  <li>
                    Mens <span><RiArrowRightSLine /></span>
                  </li>
                  <li>
                    Womens <span><RiArrowRightSLine /></span>
                  </li>
                  <li>
                    Kids <span><RiArrowRightSLine /></span>
                  </li>
                </ul>
              </li>
              <li className="popularProducts-side-list">
                Popular Products <span><RiArrowRightSLine /></span>
                <ul>
                  <li>
                    Mens <span><RiArrowRightSLine /></span>
                  </li>
              ...
              <li>
                Computer Assets <span><RiArrowRightSLine /></span>
              </li>
              <li>
                Mens Collections <span><RiArrowRightSLine /></span>
              </li>
              <li>
                Womens Collections <span><RiArrowRightSLine /></span>
              </li>
              <li>
                Kids Collections <span><RiArrowRightSLine /></span>
              </li>
            </ul>
          </li>
          ...
          <li>
            FASHION <span><IoChevronDownSharp /></span>
          </li>
          <li>
            ELECTRONICS <span><IoChevronDownSharp /></span>
          </li>
          <li>
            GROCERIES <span><IoChevronDownSharp /></span>
          </li>
          <li>
            FOOTWEAR <span><IoChevronDownSharp /></span>
          </li>
          <li>BEAUTY</li>
          <li>WELLNESS</li>
          <li>JUWELLARY</li>
